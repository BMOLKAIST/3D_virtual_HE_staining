...
parser.add_argument("--data_dir", default="J:/GUI_DEMO/dataset", type=str, dest="data_dir")
# "C:/Users/bmol/Desktop/JYpark/000. 3D RI2BF/SERVER_pix2pix/0517_HTX_pix2pix_test"
parser.add_argument("--ckpt_dir", default="J:/GUI_DEMO/models/ckpt", type=str, dest="ckpt_dir")
parser.add_argument("--log_dir", default="J:/GUI_DEMO/models/ckpt", type=str, dest="log_dir")
parser.add_argument("--result_dir", default="J:/GUI_DEMO/results", type=str, dest="result_dir")
